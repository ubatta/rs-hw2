...
for r_i in restart_iteration:
    ...
    crvs = []
    nq_t = time.time()
    for i, j in enumerate([pynp.random.randint(2,size=10) for hm in range(10)]):
        test = mlrh.DiscreteOpt(length=10, fitness_fn=mlrh.OneMax(), maximize=True, max_val=10)
...
pymap.title('OneMax Problems - RHC')
...
pymap.title('OneMax Problems - SA')
...
pymap.title('OneMax Problems - GA')
...
pymap.title('OneMax Problems - MIMIC')
...
pymap.title('OneMax Problems - MIMIC - Fitness')
pymap.xlabel('Percentage and Size of Sample')
...
pymap.title('OneMax Problems - MIMIC - Fitness Curve')
pymap.xlabel('Percentage and Size of Sample')
pymap.ylabel("Fitness Curve")
pymap.legend(loc="best")
pymap.grid()
...
pymap.title('OneMax Problems - MIMIC - Time')
pymap.xlabel('Percentage and Size of Sample')
pymap.ylabel("Time")
pymap.legend(loc="best")
pymap.grid()
